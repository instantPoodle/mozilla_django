...
class Genre(models.Model):
    """
    Model representing a book genre (e.g. Science Fiction, Non Fiction etc).
    """
    ...
    def __str__(self):
        """
        String for represetning the model object (in Admin site etc.)
        """
        return self.name
...
class Book(models.Model):
    """
    Model respresenting a book (but not a specific copy of a book)
    """
...
class BookInstance(models.Model):
    ...
    impront = models.CharField(max_length=200)
